...
@interface SearchLocationTableViewController () <UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSLog(@"%@, %@", lat, lng);
    [self.delegate searchLocationViewController:self didPickLocationWithLattitude:lat longitude:lng];
}
